    ...
    <main class="w-full h-full flex flex-col justify-stretch">
        <div class='w-8/12 mt-5 self-center flex flex-col-reverse flex-grow md:flex-row bg-white shadow-md rounded-3xl md:px-3 md:py-8 p-0 h-max'>
            <form action="{{route('new.formSave')}}" method="post" class=" px-8 h-4/5 w-full md:px-0 md:h-full md:w-3/5 md:pl-3">@csrf
                <h3 class="text-4xl font-bold my-8 capitalize">vital form B(Overweight)</h3>
                ...
                <div class="input-container flex flex-col justify-center">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid gap-3">
                            <div class="w-full form-radio-control gap-10"><input class="cursor-pointer" type="radio" name="ondrug" value="yes" id="yes"><label class="cursor-pointer" for='yes'>Yes</label></div>
                            <div class="w-full form-radio-control gap-10"><input class="cursor-pointer" type="radio" name="ondrug" value="no" id="no"> <label class="cursor-pointer" for='no'>No</label></div>
                        </div>
                    </div>
                    <div class="mb-4">
                ...
                <!-- <button class="w-full bg-red-900 text-white rounded-md py-1 px-6 mt-2" onclick="Clear(event)">Clear</button> -->
